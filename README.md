...
<!--
**abirthapa1/abirthapa1** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/abirthapa)
[![GitHub](https://img.shields.io/badge/GitHub-%23121011.svg?style=for-the-badge&logo=github&logoColor=white)](https://github.com/abirthapa1)
...
- 🎯 Targeting roles in **Cloud Support**, **Cloud Associate**, and **Site Reliability Engineering**
- 💬 Ask me about **Terraform**, **YAML configs**, **Java**, or anything **AWS**
- ⚡ Core strengths: Infrastructure-as-Code · CI/CD Pipelines · Container Orchestration
...
`IAM` `Encryption` `Load Balancing` `VPC` `Firewall` `Policy Enforcement` `VPN`
...
![Streak](https://streak-stats.demolab.com?user=abirthapa1&theme=tokyonight&hide_border=true)
...
📡  Monitoring & SRE          ████████████░░░░░░░░  Prometheus · Grafana · CloudWatch
```
...
- 📜 **AWS Solutions Architect / Cloud Practitioner** certification
- 🔍 Deepening knowledge in **SRE principles** (SLOs, SLIs, error budgets)
- 🧪 Building hands-on projects with **Terraform modules** and **Kubernetes operators**
